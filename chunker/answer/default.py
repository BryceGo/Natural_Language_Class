...
#	init = 0
#	x = 0
#	while(init < len(train_data)):
#		while(x < len(train_data[init][1])):
#			current_feature = train_data[init][1][x]
#			feat_vec[current_feature,tagset[1]] = 0 #?????
#			x = x + 1
#
#		init = init + 1
